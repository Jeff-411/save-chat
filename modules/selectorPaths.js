...
export const THREAD = `${THREAD_PARENT} > div`
  ...
  export const QA_PAIR = `${THREAD} > .pb-lg`
    // Q/A Pair left - Chat
    export const QA_PAIR_CHAT = `${QA_PAIR} > div> .col-span-8` // 1st child - Chat section
      // Question container
    ...
    // Q/A Pair right - Options
    export const QA_PAIR_OPTIONS = `${QA_PAIR} > div> .col-span-4` // 2nd child - Search section

  
  // Ask follow-up question <input> box
